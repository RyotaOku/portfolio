...
import { ArchiveItem, Archive } from '@/pages/oku/types/portfolioTypes/portfolioTypes'
...
async function getAllArchives(client: any) {
    ...
    const result: Archive = [{
        ...
        summary: '実際に予定を追加したりできる。ナイトモードにも対応',
        ...
        summary: 'ダラダラ中に思いついた作品。フロントエンドエンジニアとしての意地。',
