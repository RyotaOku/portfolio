...
async function getAllArchives(client: any) {
    ...
    const result: Archive = [{
        ...
        explanation: '希望進路・得意分野・将来の理想像などをもとに、ユーザーにさまざまなアドバイスを提供し、MBTI診断のような自己診断・分析結果を提供する。<br>全体的なデザインは、「海外発のツール」をコンセプトに。<br>チームの目的を「共同制作で良いものを作る」ではなく(当然の為)、「チーム制作を通じて得るものを最大化させる」とし、後輩の意見を最大限尊重しながら制作。',
        tech: ['React', 'Next.js', 'TypeScript', 'HTML', 'CSS'],
        app: ['Visual Studio Code', 'PgAdmin']
    }, {
